...
public class TestEnumeraciones {
    public static void main(String[] args) {
        ...
        System.out.println("Continente N° 1: " +Continentes.AMERICA);
        ...
        System.out.println("N° de habitantes en el 4to continente: "+Continentes.EUROPA.getHabitantes());
        ...
        System.out.println("N° de habitantes en el 4to continente: "+Continentes.ASIA.getHabitantes());
        
        System.out.println("Continente N° 3: " +Continentes.OCEANIA);
    ...
    private static void indicarDiaSemana(Dias dias){
        switch(dias){
            ...
            case DOMINGO:
                ...
                break;
            default:
                System.out.println("ERROR: No es un dia de la semana");
        }
    }
